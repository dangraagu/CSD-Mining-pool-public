...
impl MiningBackend for OpenclBackend {
    ...
    fn hash_range(
        ...
        loop {
            ...
            // between-launch cancel check. It abandons a now-stale sweep on a newer
            // job; it does NOT touch the kernel enqueue, nonce iteration, digest, or
            // target compare — every hash stays byte-identical to a full sweep.
